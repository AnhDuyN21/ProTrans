...
namespace WebAPI.Controllers.Documents
{
	public class DocumentController : BaseController
	{
		...
		[HttpGet("GetDocumentsToBeNotarizedByOrderId")]
		public async Task<IActionResult> GetDocumentsToBeNotarizedByOrderId(Guid id)
		{
			var result = await documentService.GetDocumentsToBeNotarizedByOrderIdAsync(id);
			return Ok(result);
		}
