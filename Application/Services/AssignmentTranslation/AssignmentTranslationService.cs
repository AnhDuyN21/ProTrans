...
namespace Application.Services.AssignmentTranslation
{
    public class AssignmentTranslationService : IAssignmentTranslationService
    {
        ...
        public async Task<ServiceResponse<IEnumerable<AssignmentTranslationByTranslatorIdDTO>>> GetAllAssignmentTranslationByTranslatorIdAsync(Guid Id)
        {
            ...
            try
            {
                ...
                var assignmentTranslationDTOs = _mapper.Map<List<AssignmentTranslationByTranslatorIdDTO>>(AssignmentTranslationList);
